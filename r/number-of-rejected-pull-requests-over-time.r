...
month.plot <- barplot(pr_number_over_time.month, beside=TRUE, ylim=c(0,50), legend=c("merged", "rejected"));
...
year.plot <- barplot(pr_number_over_time.year, beside=TRUE, ylim=c(0,200), legend=c("merged", "rejected"));
