...
month.plot <- barplot(pr_number_over_time.month, beside=TRUE, ylim=c(0,100), main="Number of Pull Requests merged/rejected over months", legend=c("merged Pull Requests", "rejected Pull Requests"));
...
year.plot <- barplot(pr_number_over_time.year, beside=TRUE, ylim=c(0,300), main="Number of Pull Requests merged/rejected over year", legend=c("merged Pull Requests", "rejected Pull Requests"));
