...
month.plot <- barplot(pr_number_over_time.month, names.arg=unique(paste(month, year)), ylim=c(0,55));
...
year.plot <- barplot(pr_number_over_time.year, names.arg=unique(year), ylim=c(0,220));
